...
const flex = document.getElementById('cardB');                               // task cards body
...
const page2Contains = document.getElementById('nextp_Contains');
...
function scratchTodo(e) {
    ...
    if (item.classList.contains('pendingIcon')) {
        ...
        item.parentElement.classList.toggle('t1');
